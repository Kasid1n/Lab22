...
ComplexNumber ComplexNumber::operator/(const ComplexNumber &c){
	return ComplexNumber(((real*c.real)/(pow(c.real,2)+pow(c.imag,2)))+((imag*c.imag)/(pow(c.real,2)+pow(c.imag,2)))
	,((real*c.imag)/(pow(c.real,2)+pow(c.imag,2)))-((imag*c.real)/(pow(c.real,2)+pow(c.imag,2))));
